    ...
    <div class="tabs">
      ...
      <nav>
        <div class="nav nav-tabs" id="nav-tab" role="tablist">
          ...
          <button class="nav-link dropdown" id="nav-board-tab" data-bs-toggle="tab" data-bs-target="#nav-board"
            ...
            <p class="dropdown-toggle" data-bs-toggle="dropdown" role="button" aria-expanded="false"
             >공고</p>
          ...
          <!-- 몽타쥬 -->
          <button class="nav-link" id="nav-companion-tab" data-bs-toggle="tab" data-bs-target="#nav-montage"
            type="button" role="tab" aria-controls="nav-companion" aria-selected="false"
            @click="getMyMontage()">몽타쥬</button>
      ...
      <div class="tab-content" id="nav-tabContent">
        ...
        <div class="tab-pane fade show active" id="nav-board" role="tabpanel" aria-labelledby="nav-board-tab"
          tabindex="1" v-show="recruitments.length > 0">
          <div class="col" v-for="recruitment in recruitments" :key="recruitment.id">
            <div class="card" id="board">
              <img :src="recruitment.image" alt="" @click="goToBoardDetail(recruitment.id)" width="300px"
                height="200px">
        ...
        <div class="tab-pane fade show active" id="nav-applylist" role="tabpanel" aria-labelledby="nav-apply-tab"
          tabindex="1" v-show="applys.length > 0">
        ...
        <div class="tab-pane fade show active" id="nav-postlist" role="tabpanel" aria-labelledby="nav-post-tab"
          tabindex="1" v-show="posts.length > 0">
        ...
        <div class="tab-pane fade" id="nav-montage" role="tabpanel" aria-labelledby="nav-montage-tab" tabindex="2">
          ...
          <div class="tab-pane fade show active" id="nav-montageList" role="tabpanel" aria-labelledby="nav-follow-tab"
            tabindex="1" v-if="montages.length > 0">
        ...
        <div class="tab-pane fade" id="nav-companion" role="tabpanel" aria-labelledby="nav-companion-tab" tabindex="3">
          <div class="tab-pane fade show active" id="nav-postlist" role="tabpanel" aria-labelledby="nav-follow-tab"
            tabindex="1" v-if="followings.length > 0">
          ...
          <div class="tab-pane fade show active" id="nav-postlist" role="tabpanel" aria-labelledby="nav-follow-tab"
            tabindex="1" v-if="followers.length > 0">
