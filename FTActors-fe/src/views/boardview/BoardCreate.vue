<template>
  <div class="container my-5">
    <div class="row justify-content-center">
      <div class="col-md-6">
        <h1 class="text-center mb-4">공고 제작 페이지</h1>
        <fieldset class="p-4 border rounded">
          <div class="mb-3">
            <label for="title" class="form-label">공고제목</label>
            <input type="text" id="title" v-model="title" placeholder="공고 제목을 입력해주세요" class="form-control" />
          </div>
          <div class="mb-3">
            <label for="content" class="form-label">내용</label>
            <textarea id="content" v-model="content" placeholder="공고 내용을 입력해주세요" class="form-control"></textarea>
          </div>
          <div class="mb-3">
            <label for="postMemberId" class="form-label">회원 이름</label>
