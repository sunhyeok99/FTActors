...
public class ProfileController {
    ...
    public ResponseEntity<?> createProfile(@RequestBody ProfileRequest profileRequest, HttpSession session) { //파라미터 추후에 변경
        log.info("프로필 만들기~! ");
    ...
    public ResponseEntity<?> modifyProfile(@RequestParam(name = "profile_id") Long profileId, HttpSession session,
